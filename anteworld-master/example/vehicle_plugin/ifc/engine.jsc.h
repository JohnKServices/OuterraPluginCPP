...
#include <comm/intergen/ifc.jsc.h>
...
public:
    ...
    static iref<xt::engine> get( const jsc::script_handle& script, const coid::token& bindvar = coid::token(), JSContextRef ctx=0 )
    {
        typedef iref<xt::engine> (*fn_bind)(const jsc::script_handle&, const coid::token&, JSContextRef);
